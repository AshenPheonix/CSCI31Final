...
riot.tag2('join', '<form> <form> <fieldset> <legend>Join APG/Blog </legend> <div class="form-group"> <label for="username">User Name</label> <input type="text" name="username" id="username" value="" placeholder="Username"> </div> <div class="form-group"> <label for="f_name">First Name</label> <input type="text" name="f_name" id="firstname" value="" placeholder="First Name"> </div> <div class="form-group"> <label for="l_name">Last Name</label> <input type="text" name="l_name" id="lastname" value="" placeholder="Last Name"> </div> <div class="form-group"> <label for="password">Pass Word</label> <input type="password" name="password" id="password" value="" placeholder="Password Please"> </div> <button type="submit" class="btn btn-primary" id="subbut" onclick="{submit}">Submit</button> <span class="Error-Field" id="errorfield" __hidden="{!error}"> Error in Username or Password </span> </fieldset> </form> </form>', 'join .Error-Field,[riot-tag="join"] .Error-Field,[data-is="join"] .Error-Field{ background-color: red; color: white; }', '', function(opts) {
    this.error=false;
    this.on("mount", () => {
