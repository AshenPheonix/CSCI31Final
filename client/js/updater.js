...
riot.tag2('updater', '<form> <div class="form-group"> <label for="username">User Name</label> <input type="text" class="form-control" id="username" placeholder="{username}"> </div> <div if="{opts.which==\'post\'}"> <div class="form-group"> <label for="title">Title</label> <input type="text" class="form-control" id="title" placeholder="{title}"> </div> <textarea id="body" rows="20"></textarea> </div> <div if="{opts.which==\'user\'}"> <div class="form-group"> <label for="firstname">First Name</label> <input type="text" class="form-control" id="firstname" placeholder="{name_f}"> </div> <div class="form-group"> <label for="lastname">Last Name</label> <input type="text" class="form-control" id="lastname" placeholder="{name_l}"> </div> </div> <br><br> <button type="button" onclick="{submit}">Change</button> </form>', 'updater p,[riot-tag="updater"] p,[data-is="updater"] p{ color: #000; }', '', function(opts) {
    this.on("mount", () => {
      if (opts.which=='post') {
