...
riot.tag2('main', '<h4> Welcome<span if="{logged}"> {username}</span>, feel free to look at any of our articles.<br> If you log in, or are logged in, you may edit and add articles as well. <div each="{posts}" class="col-md-12"> <hr> <a href="" onclick="{goto}" riot-src="{this.post_id}"> <div> {this.post_title} &nbsp;&nbsp;--{this.username} </div> </a> <hr> </div> </h4>', 'main p,[riot-tag="main"] p,[data-is="main"] p{ color: #000; }', '', function(opts) {
    this.on("mount", () => {
